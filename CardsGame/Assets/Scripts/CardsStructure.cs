...
public class CardsStructure : MonoBehaviour
{
    ...
    private void Start()
    {
        //para probar el funcionamiento de la creacion de cartas no se desarrollara la parte de seleccionar las cartas de la mano, sino que será aleatorio
        deck1 = CreateHand();
        deck2 = CreateHand();

        //Pool de 5 cartas máximas por mano
